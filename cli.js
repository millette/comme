...
// const so = require('./jido2018-sample-150-1.json').features
// const so = require('./jido2018-sample-150-2.json').features
// const so = require('./jido2018-new-sample-150-1.json').features
const so = require('./jido2018-new-sample-150-2.json').features
